...
public class ChatApp {
    ...
    public static void main(String[] args) {
        ...
        ChatMessageContent messageContent1 = new ChatMessageContent(myUser, "Welcome to the group!", new Date());
        ...
        messageDistributor.sendChatMessage(chatGroup, messageContent1);
